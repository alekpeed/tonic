...
// :feature:diagnostic — Module 0 UI: pitch direction, same/different, tonal
// memory span, amusia soft-screen. See docs/08-UI-SPEC.md.
plugins {
...
android {
    namespace = "com.tonic.feature.diagnostic"
    compileSdk = 35
...
dependencies {
    ...
    // Renders this module's screens in a JVM test, as :feature:practice has since Stage 7.
