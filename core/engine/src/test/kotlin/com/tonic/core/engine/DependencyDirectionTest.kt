...
/**
 * Enforces docs/04-ARCHITECTURE.md §2 for `:core:engine`. See the identical
 * test in `:core:model` for rationale.
 */
class DependencyDirectionTest {
    ...
    fun `main source set contains no android imports`() {
        ...
        assertTrue(
            violations.isEmpty(),
            "Forbidden android.*/androidx.* imports found in :core:engine:\n" +
