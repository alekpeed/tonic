...
object M2ItemGenerator {
    fun generate(
        ...
        val keyValue = KeySampler.pick(keyPool, history.recentKeys, random)
        ...
        val tonicMidi = tonicMidiNear(registerRange, key)
        ...
        return M2GenerationResult(item, history.with(targetDegree, keyValue, octaveOffset))
    }
