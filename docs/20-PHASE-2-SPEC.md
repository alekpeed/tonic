...
Do not start Phase 2 without answering these:
...
4. **Minor cadence with major or minor V** (§3, `M10`) — default is major V; whether to add a natural-minor variant is open.

⚠️ All four depend on things Phase 1 will teach us. That is the cost of designing ahead, and it is stated here rather than hidden.
